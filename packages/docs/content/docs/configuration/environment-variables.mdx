...
| Environment Variable | UI Setting         | Type    | Default | Description                                                                                                                                                                                                            |
| -------------------- | ------------------ | ------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `LOG_LEVEL`          | Log Level          | enum    | `info`  | How much detail to log. Takes effect immediately.                                                                                                                                                                      |
| `LOG_FORMAT`         | Log Format         | enum    | `json`  | How log lines are printed to the console. `json` is recommended for production. Takes effect immediately, so the console carries both shapes across a switch — a log collector parsing JSON will see the pretty lines. |
